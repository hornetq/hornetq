 ...
 */
public class AcknowledgmentCollector2 extends Lockable implements AcknowledgmentCollectorFacade2
{
   // Constants -----------------------------------------------------

   private static final Logger log = Logger.getLogger(AcknowledgmentCollector2.class);
   ...
   public AcknowledgmentCollector2(Replicator peer)
   {
      this.peer = peer;
      unacked = new HashMap();
      acked = new HashMap();
   ...
   // AcknowledgmentCollectorFacade2 implementation ----------
