              ...
              XATopicSession
{
   ...
   public QueueBrowser createBrowser(Queue queue) throws JMSException
   {
	...
	public QueueBrowser createBrowser(Queue queue, String messageSelector) throws JMSException
	{
      ...
      BrowserDelegate browserDelegate = delegate.createBrowser(queue, messageSelector);
      return new JBossBrowser(browserDelegate, queue, messageSelector);
	}
         ...
         throws JMSException
   {
                                         ...
                                         boolean noLocal) throws JMSException
	{
      ...
      ConsumerDelegate consumerDelegate =
            delegate.createConsumer(destination, null, messageSelector, noLocal);
      return new JBossConsumer(consumerDelegate, destination, messageSelector, noLocal);
	}
   ...
   public TopicSubscriber createDurableSubscriber(Topic topic, String name) throws JMSException
   {
	...
	{
      return (TemporaryQueue)delegate.
            createTempDestination(JBossTemporaryDestination.TEMPORARY_QUEUE);
	}

	public TemporaryTopic createTemporaryTopic() throws JMSException
	{
      return (TemporaryTopic)delegate.
            createTempDestination(JBossTemporaryDestination.TEMPORARY_TOPIC);
	}
