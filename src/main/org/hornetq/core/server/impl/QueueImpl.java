...
public class QueueImpl implements Queue
{
   ...
   */
   ...
   public int deleteMatchingReferences(final int flushLimit, final Filter filter) throws Exception
   {
    ...
    * @throws Exception
    */
   private synchronized int iterQueue(final int flushLimit, final Filter filter, QueueIterateAction messageAction) throws Exception
   {
      int count = 0;
      int txCount = 0;
