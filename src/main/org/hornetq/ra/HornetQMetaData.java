 ...
 * @version $Revision:  $
 */
public class HornetQMetaData implements ManagedConnectionMetaData
{
   /** The logger */
   private static final Logger log = Logger.getLogger(HornetQMetaData.class);
    ...
    */
   public HornetQMetaData(final HornetQManagedConnection mc)
   {
      if (trace)
      {
