...
{
   /** The logger */
   private static final Logger log = Logger.getLogger(HornetQObjectMessage.class);
    ...
    */
   public HornetQObjectMessage(final ObjectMessage message, final HornetQSession session)
   {
