 ...
 * @version $Revision: $
 */
public class HornetQXAResource implements XAResource
{
   /** The logger */
   private static final Logger log = Logger.getLogger(HornetQXAResource.class);

   /** Trace enabled */
   private static boolean trace = log.isTraceEnabled();

   /** The managed connection */
   private final HornetQManagedConnection managedConnection;
    ...
    */
   public HornetQXAResource(final HornetQManagedConnection managedConnection, final XAResource xaResource)
   {
      if (trace)
      {
