...
/**
 * This packet is used to transfer an on-going XA transaction
 * (xid) to the failed over session. On failover the session's tx 
 * will be marked as rollback only. If the xid is not transferred
 * to the new failed over session, the subsequent rollback call
 * will end in failure.
 * 
 * @author <a href="mailto:hgao@redhat.com">Howard Gao</a>.
 *
 */
public class CreateSessionMessageV2 extends PacketImpl
{
   private String name;
   ...
   public CreateSessionMessageV2(final String name,
   ...
   public void encodeRest(final HornetQBuffer buffer)
   {
      ...
      XidCodecSupport.encodeXid(curXid, buffer);
   }
   ...
   public void decodeRest(final HornetQBuffer buffer)
   {
      ...
      curXid = XidCodecSupport.decodeXid(buffer);
   }
   ...
   public int hashCode()
   {
      ...
      result = prime * result + ((curXid == null) ? 0 : curXid.hashCode());
      return result;
   }
   ...
   public boolean equals(Object obj)
   {
      ...
      if (!super.equals(obj))
         return false;
      if (!(obj instanceof CreateSessionMessageV2))
         return false;
      CreateSessionMessageV2 other = (CreateSessionMessageV2)obj;
      ...
      if (xa)
      {
         if (curXid != null)
         {
            return curXid.equals(other.curXid);
         }
         else
         {
            if (other.curXid != null)
               return false;
         }
      }
      return true;
