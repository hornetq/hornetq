...
public class PerfCharter
{
   ...
   protected void run()
   {
      try
      {
         ...
         pm = new JDBCPersistenceManager("jdbc:hsqldb:hsql://localhost:7776");
         pm.start();
         
         outputDir = new File("perf-output");
         
         File outputFile = new File(outputDir, "jms-perf-results.html");
