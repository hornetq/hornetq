...
public class SharedPipeOutputTest extends MessagingTestCase
{
   ...
   public void testTwoInputsSharingAnOutput() throws Exception
   {
      ...
      assertTrue(messages.contains(new CoreMessage("GENERATED BY ONE")));
      assertTrue(messages.contains(new CoreMessage("GENERATED BY TWO")));
   ...
   private class Sender implements Runnable
   {
      ...
      public void run()
      {
         Message m = new CoreMessage("GENERATED BY " + name);
