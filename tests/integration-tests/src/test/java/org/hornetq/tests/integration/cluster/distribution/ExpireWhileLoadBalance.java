...
public class ExpireWhileLoadBalance extends ClusterTestBase
{
   ...
   public void setUp() throws Exception
   {
      ...
      setupClusterConnection("cluster0", "queues", true, 1, true, 0, 1, 2);
      setupClusterConnection("cluster1", "queues", true, 1, true, 1, 0, 2);
      setupClusterConnection("cluster2", "queues", true, 1, true, 2, 0, 1);
