...
public class JMSBridgeClusteredTest extends ClusteredBridgeTestBase
{
   ...
   public void testCrashAndFailoverWithMessagesAtMostOnce() throws Exception
   {
      performSourceAndTargetCrashAndFailoverWithMessages(QualityOfServiceMode.AT_MOST_ONCE);
   }
