...
public interface ClusterConnection extends HornetQComponent, ClusterTopologyListener
{
   ...
   void nodeAnnounced(long eventUID, String nodeID, String backupGroupName, String exportGroupName, Pair<TransportConfiguration, TransportConfiguration> connectorPair, boolean backup);
