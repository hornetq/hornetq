...
public class HornetQConnection implements Connection
{
   ...
   private final HornetQConnectionFactory factoryReference;
                            ...
                            final ClientSessionFactory sessionFactory, HornetQConnectionFactory factory)
   {
      ...
      this.clientID = factory.getClientID();
      ...
      this.dupsOKBatchSize = factory.getDupsOKBatchSize();
      this.transactionBatchSize = factory.getTransactionBatchSize();
   ...
   protected void checkTempQueues(Destination destination) throws JMSException
   {
   ...
   {
      return "HornetQConnection(factory=" + factoryReference + ", hash=" + hashCode() + ")";
   }
